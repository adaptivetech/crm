...
<head>
    <meta charset="UTF-8">
    <title>Triple Jet Settlement CRM</title>
  ...
  if ($('.menu').hasClass('bar')) {
    ...
    <nav id="myNavmenu" class="navmenu navmenu-default navmenu-fixed-left offcanvas-sm" role="navigation">
        <div class="list-group panel">
            <p class=" list-group-item siderbar-top" title=""><img src="{{url('images/sqone_logo.png')}}" alt=""></p>
            ...
            <a href="#debts" class=" list-group-item" data-toggle="collapse" data-parent="#MainMenu"><i
                        class="glyphicon sidebar-icon glyphicon-usd"></i><span id="menu-txt">{{ __('Debts') }}</span>
            <i class="ion-chevron-up  arrow-up sidebar-arrow"></i></a>
            <div class="collapse" id="debts">
                <a href="{{ route('debts.index')}}" class="list-group-item childlist">{{ __('All Debts') }}</a>
                @if(Entrust::can('debt-create'))
                    <a href="{{ route('debts.create')}}"
                       class="list-group-item childlist">{{ __('New Debt') }}</a>
                @endif
            </div>
