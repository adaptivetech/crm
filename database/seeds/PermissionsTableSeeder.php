...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $createDebt = new Permissions;
        $createDebt->display_name = 'Create debt';
        $createDebt->name = 'debt-create';
        $createDebt->description = 'Permission to create debt';
        $createDebt->save();

        $updateDebt = new Permissions;
        $updateDebt->display_name = 'Update debt';
        $updateDebt->name = 'debt-update';
        $updateDebt->description = 'Permission to update debt';
        $updateDebt->save();
    }
}
