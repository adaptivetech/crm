...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['prefix' => 'users'], function () {
        ...
        Route::get('/debtdata/{id}', 'UsersController@debtData')->name('users.debtdata');
    ...
    Route::group(['prefix' => 'debts'], function () {
        Route::get('/data', 'DebtsController@anyData')->name('debts.data');
        Route::get('/getagreements', 'DebtsController@getAgreements');
        Route::patch('/updateagreement/{id}', 'DebtsController@updateAgreement');
        Route::patch('/updateassign/{id}', 'DebtsController@updateAssign');
        Route::patch('/updatestatus/{id}', 'DebtsController@updateStatus');
    });
