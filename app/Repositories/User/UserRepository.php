...
class UserRepository implements UserRepositoryContract
{
    ...
    public function destroy($request, $id)
    {
        ...
        if($request->debts == "move_all_debts" && $request->debt_user != "") {
            $user->moveDebts($request->debt_user);
        }
        ...
        try {
            ...
            dd($e);
            Session()->flash('flash_message_warning', 'User can NOT have, leads, debts, clients, or tasks assigned when deleted');
        }
    }
}
