...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        'debt.create' => [ \App\Http\Middleware\Debt\CanDebtCreate::class ],
        'debt.assigned' => [ \App\Http\Middleware\Debt\IsDebtAssigned::class ],
        'debt.update.status' => [ \App\Http\Middleware\Debt\CanDebtUpdateStatus::class ],
